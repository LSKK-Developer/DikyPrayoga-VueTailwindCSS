<template>
  <header class="py-6">
    <div class="container flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
      <div class="text-lg font-bold">Diky Ganteng</div>
  ...
  <div class="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
    <div class="flex flex-wrap md:flex-nowrap">
      ...
      <img src="../assets/img/man.png" alt="Man" class="w-3/4 mt-12 md:absolute -mt-6 md:mt-0 right-0 -z-1" />
    </div>
  </div>
  ...
  <div class="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
    <section class="w-full">
      ...
      <p class="section-paragraph">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta adipisci consequuntur aliquid repudiandae veritatis odio qui id ipsam repellendus totam.</p>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
        ...
        <img
          ...
          class="w-full hidden md:block md:col-span-2 lg:col-span-1 bg-nav h-36 lg:h-72 object-cover"
        />
      </div>
    </section>
  </div>
      ...
      <div class="space-y-12 my-16">
        <div class="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
          ...
          <div class="flex flex-wrap justify-center text-center lg:text-left lg:block">
            ...
            <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta adipisci consequuntur aliquid repudiandae veritatis odio qui id ipsam repellendus totam.</p>
          </div>
        </div>
        <div class="w-full border border-nav p-16 lg:px-32 lg:py-20 lg:space-x-32 flex justify-center lg:justify-start flex-wrap lg:flex-nowrap">
          <!-- Client logo -->
      ...
      <div class="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
        ...
        <div class="mt-12">
          ...
          <div class="flex mt-20 space-x-6">
            <!-- Skype -->
            <a href="#">
              <svg class="w-8 h-8 lg:w-12 lg:h-12" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <!-- Twitter -->
            <a href="#">
              <svg class="w-8 h-8 lg:w-12 lg:h-12" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
